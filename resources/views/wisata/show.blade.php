...
<head>
    ...
    <title>Profil Wisata - Desa Badak Mekar</title>
...
<body>
        ...
        <div class="container" style="z-index: 3">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="home-info">
                        <h1 style="margin-bottom: 10px;">Wisata {{ $list->nama_wisata }}</h1>
                        <p style="color: white; opacity:0.8; margin-bottom:30px;">
                            {{ $list->header_wisata }}
                        </p>
                        <a href="#about" class="btn section-btn smoothScroll">Selengkapnya</a>
                        <span>
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="home-video">
                        <div class="embed-responsive embed-responsive-16by9">
                            <iframe src={{ $list->link_wisata }} frameborder="0" allowfullscreen></iframe>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-5 col-sm-6">
                    <div class="about-info">
                        <div class="section-title">
                            <h2>Tentang Tempat</h2>
                            <span class="line-bar">...</span>
                        </div>
                        <p>{{ $list->deskripsi_wisata }}</p>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class=" skill-thumb  tentang-tempat">
                        ...
                        <br>
                        <a href="tel:{{ $list->kontak_wisata }}" style="color: #6cbb94">{{ $list->kontak_wisata }}</a>
                        <br>
                        <br>
                        <strong>Alamat</strong>
                        <br>
                        <a href="{{ $list->link_wisata_2 }}" style="color: #6cbb94">{{ $list->alamat_wisata }}</a>
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="google-map">
                        <iframe src="{{ $list->peta_wisata }}" width="600" height="450" style="border:0;"
    ...
    <!-- BLOG -->
    {{-- <section id="listwisata" data-stellar-background-ratio="0.5">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6">
                    ...
                    <div class="media blog-thumb">
                        <div class="media-object media-left">
                            <a href="blog-detail.html"><img src="images/gubuk semar_1.png" class="img-responsive"
                                    alt=""></a>
                        </div>
                        <div class="media-body blog-info">
                            <h3><a href="blog-detail.html">Gubuk Semar</a></h3>
                            <p>Lorem ipsum dolor sit consectetur adipiscing morbi venenatis.</p>
                            <a href="blog-detail.html" class="btn section-btn">Lihat ></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-sm-6">
                    ...
                    <div class="media blog-thumb">
                        ...
                        <div class="media-body blog-info">
                            <h3><a href="blog-detail.html">Wisata 2</a></h3>
                            <p>Lorem ipsum dolor sit consectetur adipiscing morbi venenatis.</p>
                            <a href="blog-detail.html" class="btn section-btn">Lihat ></a>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-sm-6">
                    ...
                    <div class="media blog-thumb">
                        ...
                        <div class="media-body blog-info">
                            <h3><a href="blog-detail.html">Wisata 3</a></h3>
                            <p>Lorem ipsum dolor sit consectetur adipiscing morbi venenatis.</p>
                            <a href="blog-detail.html" class="btn section-btn">Lihat ></a>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-sm-6">
                    ...
                    <div class="media blog-thumb">
                        ...
                        <div class="media-body blog-info">
                            <h3><a href="blog-detail.html">Wisata 4</a></h3>
                            <p>Lorem ipsum dolor sit consectetur adipiscing morbi venenatis.</p>
                            <a href="blog-detail.html" class="btn section-btn">Lihat ></a>
                        </div>
                    </div>
                    ...
                    <div class="footer-thumb">
                        ...
                        <ul class="footer-link">
                            @foreach ($layanan as $item)
                                <li><a href="{{ route('layanan.show', $item->ID) }}">{{ $item->nama_layanan }}</a>
                                </li>
                            @endforeach
                        </ul>
                    </div>
