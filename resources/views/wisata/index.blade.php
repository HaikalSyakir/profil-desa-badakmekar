...
<head>
    ...
    <title>Wisata - Desa Badak Mekar</title>
        ...
        <div class="container" style="z-index: 3">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="home-info">
                        <h1 style="margin-bottom: 10px;">Wisata Desa Badak Mekar</h1>
                        <p style="color: white; opacity:0.8; margin-bottom:30px;">
                            Nikmati pesona alam yang indah, budaya lokal yang kaya, dan keramahan penduduk di Desa Badak
                            Mekar. Jelajahi berbagai tempat menarik dan buat kenangan tak terlupakan bersama
                            kami.
                        </p>
                        <a href="#listwisata" class="btn section-btn smoothScroll">Lihat Daftar</a>
                        <span>
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="home-video">
                        <div class="embed-responsive embed-responsive-16by9">
                            <iframe src="https://www.youtube.com/embed/EyrfLacBqWo?si=4idz1ehnWQiH_bTl" frameborder="0"
                    ...
                    <div class="col-md-6 col-sm-6">
                        ...
                        <div class="media blog-thumb">
                            <div class="media-object media-left">
                                <a href="blog-detail.html"><img src="{{ asset($item->gambar_wisata_2) }}"
                                        class="img-responsive" alt=""></a>
                            </div>
                            <div class="media-body blog-info">
                                <h3><a href="blog-detail.html">{{ $item->nama_wisata }}</a></h3>
                                <p>{{ Str::words($item->deskripsi_wisata, 12, '...') }}</p>
                                <a href="{{ route('wisata.show', $item->ID) }}" class="btn section-btn">Lihat ></a>
                            </div>
                        </div>
                    </div>
                @endforeach
